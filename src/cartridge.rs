...
impl Cartridge {
    ...
    pub fn from_file(filepath: &str) -> Result<Cartridge, String> {
        ...
        if is_unf {
            ...
            let using_chr_ram = chr_rom.is_empty() || matches!(memory_mapper, 268 | 286 | 522 | 536 | 541 | 544 | 547 | 581 | 583 | 587 | 589 | 761 | 767);
            let chr_ram = if using_chr_ram || matches!(memory_mapper, 268 | 286 | 522 | 536 | 541 | 544 | 547 | 581 | 583 | 587 | 589 | 761 | 767) {
        ...
        let chr_ram = if memory_mapper == 13 {
            ...
            vec![0u8; total_ram]
        } else if matches!(memory_mapper, 124 | 233 | 235 | 237 | 241 | 242 | 245 | 247 | 262 | 268 | 342 | 372 | 375 | 381 | 382 | 393 | 396 | 399 | 400 | 402 | 448 | 452 | 453 | 454 | 460 | 462 | 466 | 470 | 481 | 482 | 485 | 491 | 500 | 501 | 502 | 508 | 512 | 515 | 517 | 518 | 520 | 522 | 536 | 541 | 544 | 547 | 555 | 573 | 574 | 581 | 583 | 587 | 589 | 761 | 767) || crate::mappers::one_bus::is_onebus_mapper(memory_mapper) {
            vec![0u8; 0x2000]
        ...
        if memory_mapper == 286 || matches!(memory_mapper, 74 | 119 | 111 | 124 | 191 | 192 | 194 | 195 | 233 | 235 | 237 | 241 | 242 | 245 | 247 | 252 | 253 | 262 | 306 | 307 | 309 | 310 | 312 | 342 | 355 | 372 | 375 | 381 | 382 | 393 | 396 | 399 | 400 | 402 | 403 | 442 | 448 | 452 | 453 | 454 | 460 | 462 | 466 | 470 | 481 | 482 | 485 | 491 | 500 | 501 | 502 | 508 | 512 | 513 | 515 | 517 | 518 | 520 | 522 | 536 | 541 | 544 | 547 | 555 | 573 | 574 | 581 | 583 | 587 | 589 | 761 | 767) || crate::mappers::one_bus::is_onebus_mapper(memory_mapper) {
            using_chr_ram = true;
        }
