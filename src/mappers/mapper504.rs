...
impl Mapper504 {
    ...
    fn prg_raw_bank(&self, cart: &Cartridge, page: usize) -> usize {
        if (self.reg & 0x03) == 0x03 && (self.reg & 0x08) == 0 {
            let b = self.mmc3_raw_bank(cart, page & 1);
            (b & !1) | (page & 1)
        } else {
...
impl Mapper for Mapper504 {
    ...
    fn fetch_prg(&mut self, cart: &Cartridge, address: u16) -> FetchResult {
        if address >= 0x8000 {
            ...
            let bank = (self.prg_raw_bank(cart, page) & prg_and) | prg_or;
