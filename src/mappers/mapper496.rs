...
use crate::mappers::one_bus_gpio::{AttachedDevice, DeviceBinding, InverterAdderDevice, ParallelBinding};

pub struct Mapper496 {
    core: OneBus,
}

impl Default for Mapper496 {
    fn default() -> Self {
        Self::new()
    }
}
...
impl Mapper496 {
    pub fn new() -> Self {
        ...
        core.gpio[1].devices.push(AttachedDevice {
            device: Box::new(InverterAdderDevice::new()),
            binding: DeviceBinding::Parallel(ParallelBinding {
                select: 255,
                clock_to_device: 2,
                clock_from_device: 1,
                data_to_device: 4,
                data_to_device_mask: 0x0F,
                data_from_device: 3,
                data_from_device_mask: 0x01,
            }),
        });
        Self { core }
    }
