...
pub struct Mapper425 {
    core: OneBus,
}

impl Default for Mapper425 {
    fn default() -> Self {
        Self::new()
    }
}
...
impl Mapper425 {
    ...
    fn prg_or(&self) -> u16 {
        (self.core.reg4100[0xE6] as u16) << 4
    }

    fn chr_or(&self) -> usize {
        (self.core.reg4100[0xE6] as usize) << 15
    }
}

impl Mapper for Mapper425 {
    fn reset(&mut self) {
        self.core.reset();
        self.core.console_type_vt369 = true;
        self.core.reg4100[0xE6] = 0;
    }
