...
impl Mapper572 {
    ...
    fn prg_page(&self, cart: &Cartridge, address: u16) -> u16 {
        ...
        let prg_or = ((self.reg as u16) << 5) & 0xE0;
        (raw & 0x1F) | prg_or
    }
    ...
    fn chr_page(&self, address: u16) -> u16 {
        ...
        let chr_or = ((self.reg as u16) << 7) & 0x80;
        (raw & 0x7F) | chr_or
    }
}

impl Mapper for Mapper572 {
    fn reset(&mut self) {
        self.reg = 0;
        self.mmc3.reset();
    }
    ...
    fn store_prg(&mut self, cart: &mut Cartridge, address: u16, data: u8) {
        if address >= 0x6000 && address < 0x8000 {
            if (self.mmc3.prg_ram_protect & 0x40) == 0 && (self.reg & 0x08) == 0 {
