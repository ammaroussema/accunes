...
impl Mapper609 {
    ...
    fn prg_8k_bank(&self, slot: usize) -> usize {
        let mut val = self.reg as usize;
        if (self.reg & 0x20) != 0 {
            val = (val & !0x01) | (slot & 1);
        }
        if (self.reg & 0x40) != 0 {
...
impl Mapper for Mapper609 {
    ...
    fn fetch_prg(&mut self, cart: &Cartridge, address: u16) -> FetchResult {
        ...
        let bank = self.prg_8k_bank(slot);
    ...
    fn mirror_nametable(&self, _cart: &Cartridge, address: u16) -> u16 {
        mirror_h_or_v((self.reg & 0x80) != 0, address)
    }
    ...
    fn fetch_ppu(
        ...
        if address < 0x2000 {
            ...
            let mirrored = mirror_h_or_v((self.reg & 0x80) != 0, address);
