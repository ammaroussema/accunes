...
impl Mapper for Mapper588 {
    ...
    fn fetch_prg(&mut self, cart: &Cartridge, address: u16) -> FetchResult {
        ...
        if address < 0x8000 {
            ...
            let page = ((self.reg[1] & 0x07) | 0x08) as usize;
        ...
        let page = ((self.reg[0] >> 4) & 0x07) as usize;
    ...
    fn fetch_ppu(
        ...
        if address < 0x2000 {
            let page = (self.reg[0] & 0x0F) as usize;
            let offset = page * 0x2000 + (address as usize & 0x1FFF);
