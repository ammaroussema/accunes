...
impl Mapper764 {
    ...
    fn prg_16k_banks(&self) -> (usize, usize) {
        if (self.latch & 0x40) != 0 {
            ...
            (self.latch as usize, (self.latch | 7) as usize)
        }
    }
}

impl Mapper for Mapper764 {
    fn reset(&mut self) {
        self.latch = 0;
    }
    ...
    fn mirror_nametable(&self, _cart: &Cartridge, address: u16) -> u16 {
        mirror_h_or_v((self.latch & 0x20) != 0, address)
    }
    ...
    fn fetch_ppu(
        ...
        if address < 0x2000 {
            ...
            let mirrored = mirror_h_or_v((self.latch & 0x20) != 0, address);
