...
impl Mapper484 {
    ...
    fn prg_bank8(&self, cart: &Cartridge, cpu_bank: u8) -> u16 {
        ((self.prg_raw_bank(cart, cpu_bank) & self.prg_and()) as u16) | self.prg_or()
    }
}

impl Mapper for Mapper484 {
    fn reset(&mut self) {
        self.mmc3.reset();
    }
    ...
    fn fetch_prg(&mut self, cart: &Cartridge, address: u16) -> FetchResult {
        if address >= 0x8000 {
            ...
            let bank = self.prg_bank8(cart, cpu_bank) as usize;
    ...
    fn fetch_ppu(
        ...
        let bank = self.mmc3.chr_bank(address) as usize;
