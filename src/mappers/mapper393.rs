...
impl Mapper for Mapper393 {
        ...
        if address >= 0x8000 {
            if (self.outer_bank & 0x20) != 0 {
                if (self.outer_bank & 0x10) != 0 {
                    let bank_lo = ((self.latch as u16) & 7) | ((self.outer_bank as u16) << 3);
    ...
    fn fetch_ppu(
        ...
        if (self.outer_bank & 0x08) != 0 {
            ...
            let bank = (raw_bank as u16) | ((self.outer_bank as u16) << 8);
