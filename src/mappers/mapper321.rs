...
impl Mapper for Mapper321 {
    ...
    fn fetch_prg(&mut self, cart: &Cartridge, address: u16) -> FetchResult {
        ...
        if address >= 0x8000 {
            if (self.reg & 0x08) != 0 {
                let bank = (self.reg as usize & 4) | ((self.reg as usize) >> 4 & 3);
            ...
            let bank_mod = (mmc3_bank & 0x0F) | ((self.reg as usize) << 2 & !0x0F);
    ...
    fn fetch_ppu(
        ...
        if address < 0x2000 {
            ...
            let bank = (chr_bank as usize & 0x7F) | ((self.reg as usize) << 5 & !0x7F);
