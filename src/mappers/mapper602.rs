...
pub struct Mapper602 {
    prg: [u8; 8],
    chr: u8,
    hw: Um6578Hw,
}
impl Default for Mapper602 {
    fn default() -> Self { Self::new() }
}
impl Mapper602 {
    pub fn new() -> Self {
        Self { prg: [0,1,2,3,4,5,6,7], chr: 0, hw: Um6578Hw::new() }
    }
...
impl Mapper for Mapper602 {
    fn is_um6578(&self) -> bool { true }
    fn um6578_chr(&self) -> u8 { self.chr }
    fn reset(&mut self) { self.prg = [0,1,2,3,4,5,6,7]; self.chr = 0; self.hw.reset(); }
