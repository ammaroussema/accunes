...
impl Mapper470 {
    ...
    fn prg_bank32(&self) -> usize {
        ((self.latch_data & 7) | (self.outer_bank << 3)) as usize
    }
...
impl Mapper for Mapper470 {
    ...
    fn store_prg(&mut self, _cart: &mut Cartridge, address: u16, data: u8) {
        match address {
            0x5000..=0x5FFF => self.outer_bank = data,
            0x8000..=0xFFFF => self.latch_data = data,
            _ => {}
        }
    }
