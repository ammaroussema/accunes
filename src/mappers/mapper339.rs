...
impl Mapper for Mapper339 {
    ...
    fn fetch_prg(&mut self, cart: &Cartridge, address: u16) -> FetchResult {
        ...
        if address >= 0x8000 {
            if (self.reg & 0x20) != 0 {
                ...
                let outer = (self.reg as usize) << 1 & 0xF0;
            ...
            let sm = cart.sub_mapper;
            let complex_32kb = (sm == 0 && (self.reg & 6) == 6)
                || (sm == 1 && (self.reg & 0x004) != 0)
                || (sm == 2 && (self.reg & 0x101) != 0)
                || (sm == 3 && (self.reg & 0x018) != 0);
            if complex_32kb {
            ...
            let bank = (self.reg & 0x1F) as usize;
    ...
    fn fetch_ppu(
        ...
        if address < 0x2000 {
            ...
            let outer = (self.reg as usize) << 4 & 0x80;
            let bank = (chr_bank as usize & 0x7F) | outer;
