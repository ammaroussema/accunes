...
impl Emulator {
    ...
    pub fn store(&mut self, input: u8, address: u16) {
        ...
        if address < 0x2000 {
            ...
            } else if matches!(cart.memory_mapper, 21 | 22 | 23 | 25 | 85 | 520 | 526 | 529 | 530 | 542 | 544) && (address & 0xF000) == 0xF000 {
                self.irq_level_detector = false;
